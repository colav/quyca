...
def test_get_works_by_institution_with_filters(client, random_institution_id):
    response = client.get(
...
def test_get_works_by_faculty_with_filters(client, random_faculty_id):
    response = client.get(
...
def test_get_works_by_department_with_filters(client, random_department_id):
    response = client.get(
...
def test_get_works_by_group_with_filters(client, random_group_id):
    response = client.get(
