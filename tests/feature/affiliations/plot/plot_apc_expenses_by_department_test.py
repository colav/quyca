def test_it_can_plot_apc_expenses_by_department_by_institution(client, random_institution_id):
    response = client.get(
...
def test_it_can_plot_apc_expenses_by_department_by_faculty(client, random_faculty_id):
    response = client.get(
