def test_it_can_plot_articles_by_scimago_quartile_by_institution(client, random_institution_id):
    response = client.get(
...
def test_it_can_plot_articles_by_scimago_quartile_by_faculty(client, random_faculty_id):
    response = client.get(
...
def test_it_can_plot_articles_by_scimago_quartile_by_department(client, random_department_id):
    response = client.get(
...
def test_it_can_plot_articles_by_scimago_quartile_by_group(client, random_group_id):
    response = client.get(
