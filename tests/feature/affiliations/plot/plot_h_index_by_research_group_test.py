def test_it_can_plot_h_index_by_research_group_by_institution(client, random_institution_id):
    response = client.get(
...
def test_it_can_plot_h_index_by_research_group_by_faculty(client, random_faculty_id):
    response = client.get(
...
def test_it_can_plot_h_index_by_research_group_by_department(client, random_department_id):
    response = client.get(
